...
public class Test_NG_Updated_Demo {
	
	@Test(enabled = true,priority = 1,groups = {"smoke","regression"}) //(enabled = true,priority = 1,dependsOnMethods ="verifyThatUserCanAddTheProductInToCartSoftAssertion")  //(enabled = false) 
